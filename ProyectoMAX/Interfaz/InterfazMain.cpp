...
BEGIN_EVENT_TABLE(InterfazDialog, wxDialog)
    EVT_CLOSE(InterfazDialog::OnClose)
    EVT_BUTTON(idBtnQuit, InterfazDialog::OnQuit)
    EVT_BUTTON(idBtnAbout, InterfazDialog::OnAbout)
END_EVENT_TABLE()

InterfazDialog::InterfazDialog(wxDialog *dlg, const wxString &title)
...
InterfazDialog::~InterfazDialog()
{
}

void InterfazDialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}

void InterfazDialog::OnQuit(wxCommandEvent &event)
{
    Destroy();
}

void InterfazDialog::OnAbout(wxCommandEvent &event)
{
